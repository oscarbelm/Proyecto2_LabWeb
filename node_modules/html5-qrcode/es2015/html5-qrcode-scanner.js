...
import { TorchButton, TorchUtils } from "./ui/scanner/torch-button";
...
export class Html5QrcodeScanner {
    ...
    renderCameraSelection(cameras) {
        ...
        const torchButton = TorchButton.create($this.html5Qrcode, { display: "none", marginLeft: "5px" }, (errorMessage) => {
        ...
        const showTorchButtonIfSupported = (settings) => {
